...
export const SHOPS: Record<EShopCategory, ShopDef> = {
  [EShopCategory.Furniture]: {
    ...
    items: [
      { key: 'lamp', name: 'Reading Lamp', tag: 'warm glow', price: 9, size: 3, isRoomIcon: true },
      { key: 'shelf', name: 'Book Nook', tag: 'holds 30', price: 14, size: 3, isRoomIcon: true },
      { key: 'rug', name: 'Woven Rug', tag: 'soft underfoot', price: 12, size: 1.4 },
      { key: 'table', name: 'Side Table', tag: 'sturdy oak', price: 11, size: 1.5 },
      { key: 'bed', name: 'Cosy Bed', tag: 'comfy nap', price: 20, size: 3, isRoomIcon: true },
      { key: 'desk', name: 'Study Desk', tag: 'get to work', price: 15, size: 3, isRoomIcon: true },
  ...
  [EShopCategory.Room]: {
    ...
    items: [
      { key: 'window', name: 'Bay Window', tag: 'lets light in', price: 16, size: 2, isRoomIcon: true },
      { key: 'curtain', name: 'Linen Curtains', tag: 'soft drape', price: 9, size: 1.3, isRoomIcon: true },
